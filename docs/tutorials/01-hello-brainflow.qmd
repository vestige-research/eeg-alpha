...
Want to run this code yourself? Download the companion Python script: [01_hello_brainflow.py](https://github.com/vestige-research/eeg-alpha/blob/main/examples/01_hello_brainflow.py)
...
# Run the script
python examples/01_hello_brainflow.py
```
:::
